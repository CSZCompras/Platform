    ...
    var AtualizacaoDePrecos = (function () {
        ...
        AtualizacaoDePrecos.prototype.loadData = function () {
            ...
            this.productRepository
                ...
                .then(function (data) {
                _this.categories = data;
                _this.selectedCategory = data[0].id;
