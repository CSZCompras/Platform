    ...
    var Pedido = (function () {
        ...
        Pedido.prototype.simulate = function () {
            ...
            this.simulationRepository
                ...
                .then(function (x) {
                _this.simulation = x;
                if (_this.simulation.betterResults != null && _this.simulation.betterResults.length > 0) {
                    _this.simulation.betterResults[0].isSelected = true;
                    _this.selectedResult = _this.simulation.betterResults[0];
                }
