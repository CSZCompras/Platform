...
define('views/cotacao/cotacao',["require", "exports", "../../services/notificationService", "../../services/identityService", "aurelia-framework", "aurelia-router", "../../repositories/foodServiceRepository", "../../repositories/simulationRepository", "../../domain/simulationInput", "../../domain/simulationInputItem", "../../repositories/orderRepository", "aurelia-event-aggregator", "aurelia-dialog", "../components/partials/horarioDeEntregaPedido", "twitter-bootstrap-wizard", "jquery-mask-plugin", "aurelia-validation"], function (require, exports, notificationService_1, identityService_1, aurelia_framework_1, aurelia_router_1, foodServiceRepository_1, simulationRepository_1, simulationInput_1, simulationInputItem_1, orderRepository_1, aurelia_event_aggregator_1, aurelia_dialog_1, horarioDeEntregaPedido_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Pedido = (function () {
        function Pedido(router, repository, ea, dialogService, simulationRepository, orderRepository, service, nService) {
            this.router = router;
            this.repository = repository;
            this.ea = ea;
            this.dialogService = dialogService;
        ...
        Pedido.prototype.generateOrder = function () {
            var _this = this;
            this.dialogService
                .open({ viewModel: horarioDeEntregaPedido_1.HorarioDeEntregaPedido, lock: false })
                .whenClosed(function (response) {
    ...
    var AtualizacaoDePrecos = (function () {
        ...
        AtualizacaoDePrecos.prototype.save = function (product) {
            ...
            this.repository
                ...
                .then(function (result) {
                _this.nService.success('O produto foram atualizado com sucesso!');
                _this.isLoading = false;
