            ...
            if (this.foodService.cnpj.length >= 14) {
                ...
                this.consultaCNPJService
                    ...
                    if (result != null) {
                        ...
                        _this.foodService.address.cep = result.cep;
            ...
            if (this.supplier.cnpj.length >= 14) {
                ...
                this.consultaCNPJService
                    ...
                    if (result != null) {
                        ...
                        _this.supplier.address.cep = result.cep;
