    ...
    var Pedido = (function () {
        ...
        Pedido.prototype.generateOrder = function () {
            ...
            this.results.forEach(function (x) {
                var market = _this.selectedQuote.markets.filter(function (y) { return y.id == x.market.id; })[0];
