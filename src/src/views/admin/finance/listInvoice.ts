...
export class ListInvoice {
    ...
    controlDates: InvoiceControl[];
    filteredInvoices: Invoice[]
    selectedInvoice: Invoice;
    selectedControl: InvoiceControl;
    selectedControlDate: InvoiceControl;
    isLoading: boolean;
    isEditing: boolean;
    totalValue: number;
    ...
    changeControl() {
        ...
        this.repository
            .getControls(this.selectedControlDate)
            .then(x => {
                if (x.length > 0) {
    ...
    calculateTotalValue() {
        if (this.selectedControl && this.selectedControl.invoices) {
