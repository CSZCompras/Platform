...
<html lang="en">
<head>
    <title>Code coverage report for src/request-message-processor.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/request-message-processor.js</span></h1>
    <h2>
        Statements: <span class="metric">98.44% <small>(63 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; request-message-processor.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">System.register(['core-js', './http-response-message', 'aurelia-path'], function (_export) {
  'use strict';
&nbsp;
...
&nbsp;
    if (message.params) {
      ...
      url = qs ? <span class="branch-0 cbranch-no" title="branch not covered" >'' + url + '?' + qs </span>: url;
    }
&nbsp;
    message.fullUrl = url;
  }
