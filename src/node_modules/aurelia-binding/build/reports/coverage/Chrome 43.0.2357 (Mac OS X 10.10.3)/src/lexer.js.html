...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">71.31% <small>(174 / 244)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">47.62% <small>(50 / 105)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">74.19% <small>(23 / 31)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">71.37% <small>(172 / 241)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return code &gt;= $TAB &amp;&amp; code &lt;= $SPACE || code === $NBSP;</span>
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function isExponentSign(code) {</span>
<span class="cstat-no" title="statement not covered" >    return code === $MINUS || code === $PLUS;</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    switch (code) {</span>
      case $n:
<span class="cstat-no" title="statement not covered" >        return $LF;</span>
      case $f:
<span class="cstat-no" title="statement not covered" >        return $FF;</span>
      case $r:
...
<span class="cstat-no" title="statement not covered" >        return $TAB;</span>
      case $v:
<span class="cstat-no" title="statement not covered" >        return $VTAB;</span>
      default:
...
<span class="cstat-no" title="statement not covered" >      throw message || 'Assertion failed';</span>
    }
  }
  return {
    setters: [],
...
&nbsp;
        Token.prototype.withOp = <span class="fstat-no" title="function not covered" >function withOp(op) {</span>
<span class="cstat-no" title="statement not covered" >          this.opKey = op;</span>
...
&nbsp;
        Token.prototype.toString = <span class="fstat-no" title="function not covered" >function toString() {</span>
<span class="cstat-no" title="statement not covered" >          return 'Token(' + this.text + ')';</span>
        };
&nbsp;
        return Token;
      })();
...
&nbsp;
          switch (this.peek) {
            case $PERIOD:
              this.advance();
              return isDigit(this.peek) ? <span class="branch-0 cbranch-no" title="branch not covered" >this.scanNumber(start) </span>: new Token(start, '.');
            case $LPAREN:
            case $RPAREN:
            case $LBRACE:
            case $RBRACE:
...
<span class="branch-12 cbranch-no" title="branch not covered" >            case $PLUS:</span>
<span class="branch-13 cbranch-no" title="branch not covered" >            case $MINUS:</span>
<span class="branch-14 cbranch-no" title="branch not covered" >            case $STAR:</span>
<span class="branch-15 cbranch-no" title="branch not covered" >            case $SLASH:</span>
<span class="branch-16 cbranch-no" title="branch not covered" >            case $PERCENT:</span>
<span class="branch-17 cbranch-no" title="branch not covered" >            case $CARET:</span>
<span class="branch-18 cbranch-no" title="branch not covered" >            case $QUESTION:</span>
<span class="cstat-no" title="statement not covered" >              return this.scanOperator(start, String.fromCharCode(this.peek));</span>
<span class="branch-19 cbranch-no" title="branch not covered" >            case $LT:</span>
<span class="branch-20 cbranch-no" title="branch not covered" >            case $GT:</span>
<span class="branch-21 cbranch-no" title="branch not covered" >            case $BANG:</span>
<span class="branch-22 cbranch-no" title="branch not covered" >            case $EQ:</span>
<span class="cstat-no" title="statement not covered" >              return this.scanComplexOperator(start, $EQ, String.fromCharCode(this.peek), '=');</span>
<span class="branch-23 cbranch-no" title="branch not covered" >            case $AMPERSAND:</span>
<span class="cstat-no" title="statement not covered" >              return this.scanComplexOperator(start, $AMPERSAND, '&amp;', '&amp;');</span>
<span class="branch-24 cbranch-no" title="branch not covered" >            case $BAR:</span>
<span class="cstat-no" title="statement not covered" >              return this.scanComplexOperator(start, $BAR, '|', '|');</span>
<span class="branch-25 cbranch-no" title="branch not covered" >            case $NBSP:</span>
<span class="cstat-no" title="statement not covered" >              while (isWhitespace(this.peek)) {</span>
<span class="cstat-no" title="statement not covered" >                this.advance();</span>
              }
&nbsp;
<span class="cstat-no" title="statement not covered" >              return this.scanToken();</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          var character = String.fromCharCode(this.peek);</span>
<span class="cstat-no" title="statement not covered" >          this.error('Unexpected character [' + character + ']');</span>
...
&nbsp;
        Scanner.prototype.scanOperator = <span class="fstat-no" title="function not covered" >function scanOperator(start, text) {</span>
<span class="cstat-no" title="statement not covered" >          assert(this.peek === text.charCodeAt(0));</span>
<span class="cstat-no" title="statement not covered" >          assert(OPERATORS.indexOf(text) !== -1);</span>
<span class="cstat-no" title="statement not covered" >          this.advance();</span>
<span class="cstat-no" title="statement not covered" >          return new Token(start, text).withOp(text);</span>
        };
&nbsp;
        Scanner.prototype.scanComplexOperator = <span class="fstat-no" title="function not covered" >function scanComplexOperator(start, code, one, two) {</span>
<span class="cstat-no" title="statement not covered" >          assert(this.peek === one.charCodeAt(0));</span>
<span class="cstat-no" title="statement not covered" >          this.advance();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          var text = one;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (this.peek === code) {</span>
<span class="cstat-no" title="statement not covered" >            this.advance();</span>
<span class="cstat-no" title="statement not covered" >            text += two;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (this.peek === code) {</span>
<span class="cstat-no" title="statement not covered" >            this.advance();</span>
...
&nbsp;
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (OPERATORS.indexOf(text) !== -1) {
<span class="cstat-no" title="statement not covered" >            result.withOp(text);</span>
          } else {
...
&nbsp;
          while (true) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (isDigit(this.peek)) {} else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.peek === $PERIOD) {
<span class="cstat-no" title="statement not covered" >              simple = false;</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (isExponentStart(this.peek)) {
<span class="cstat-no" title="statement not covered" >              this.advance();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              if (isExponentSign(this.peek)) {</span>
<span class="cstat-no" title="statement not covered" >                this.advance();</span>
              }
&nbsp;
<span class="cstat-no" title="statement not covered" >              if (!isDigit(this.peek)) {</span>
<span class="cstat-no" title="statement not covered" >                this.error('Invalid exponent', -1);</span>
              }
&nbsp;
<span class="cstat-no" title="statement not covered" >              simple = false;</span>
            } else {
...
&nbsp;
          var text = this.input.substring(start, this.index);
          var value = simple ? parseInt(text) : <span class="branch-1 cbranch-no" title="branch not covered" >parseFloat(text);</span>
          return new Token(start, text).withValue(value);
        };
&nbsp;
        Scanner.prototype.scanString = function scanString() {
          assert(this.peek === $SQ || <span class="branch-1 cbranch-no" title="branch not covered" >this.peek === $DQ)</span>;
&nbsp;
          var start = this.index;
          var quote = this.peek;
&nbsp;
...
&nbsp;
          while (this.peek !== quote) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.peek === $BACKSLASH) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >              buffer.push(this.input.substring(marker, this.index));</span>
<span class="cstat-no" title="statement not covered" >              this.advance();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              var unescaped;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              if (this.peek === $u) {</span>
                // TODO(kasperl): Check bounds? Make sure we have test
                // coverage for this.
<span class="cstat-no" title="statement not covered" >                var hex = this.input.substring(this.index + 1, this.index + 5);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!/[A-Z0-9]{4}/.test(hex)) {</span>
<span class="cstat-no" title="statement not covered" >                  this.error('Invalid unicode escape [\\u' + hex + ']');</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                unescaped = parseInt(hex, 16);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                for (var i = 0; i &lt; 5; ++i) {</span>
<span class="cstat-no" title="statement not covered" >                  this.advance();</span>
                }
              } else {
<span class="cstat-no" title="statement not covered" >                unescaped = decodeURIComponent(this.peek);</span>
<span class="cstat-no" title="statement not covered" >                this.advance();</span>
              }
&nbsp;
<span class="cstat-no" title="statement not covered" >              buffer.push(String.fromCharCode(unescaped));</span>
<span class="cstat-no" title="statement not covered" >              marker = this.index;</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.peek === $EOF) {
<span class="cstat-no" title="statement not covered" >              this.error('Unterminated quote');</span>
            } else {
              this.advance();
            }
          }
...
&nbsp;
          ...
          var unescaped = last;
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (buffer != null) {
<span class="cstat-no" title="statement not covered" >            buffer.push(last);</span>
<span class="cstat-no" title="statement not covered" >            unescaped = buffer.join('');</span>
          }
&nbsp;
...
&nbsp;
        Scanner.prototype.error = <span class="fstat-no" title="function not covered" >function error(message) {</span>
<span class="cstat-no" title="statement not covered" >          var offset = arguments[1] === undefined ? 0 : arguments[1];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          var position = this.index + offset;</span>
<span class="cstat-no" title="statement not covered" >          throw new Error('Lexer Error: ' + message + ' at column ' + position + ' in expression [' + this.input + ']');</span>
        };
&nbsp;
        return Scanner;
      })();
