...
<html lang="en">
<head>
    <title>Code coverage report for src/array-observation.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/array-observation.js</span></h1>
    <h2>
        Statements: <span class="metric">55.68% <small>(49 / 88)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; array-observation.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">System.register(['./environment', './array-change-records', './collection-observation'], function (_export) {
  'use strict';
&nbsp;
...
&nbsp;
  function getArrayObserver(taskQueue, array) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (hasArrayObserve) {
      return new ArrayObserveObserver(array);
    } else {
<span class="cstat-no" title="statement not covered" >      return ModifyArrayObserver.create(taskQueue, array);</span>
    }
  }
&nbsp;
  return {
...
<span class="fstat-no" title="function not covered" >        function ModifyArrayObserver(taskQueue, array) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, ModifyArrayObserver);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _ModifyCollectionObserver.call(this, taskQueue, array);</span>
        }
&nbsp;
        _inherits(ModifyArrayObserver, _ModifyCollectionObserver);
&nbsp;
        ModifyArrayObserver.create = <span class="fstat-no" title="function not covered" >function create(taskQueue, array) {</span>
<span class="cstat-no" title="statement not covered" >          var observer = new ModifyArrayObserver(taskQueue, array);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          array['pop'] = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            var methodCallResult = arrayProto['pop'].apply(array, arguments);</span>
<span class="cstat-no" title="statement not covered" >            observer.addChangeRecord({</span>
              type: 'delete',
              object: array,
              name: array.length,
              oldValue: methodCallResult
            });
<span class="cstat-no" title="statement not covered" >            return methodCallResult;</span>
          };
&nbsp;
<span class="cstat-no" title="statement not covered" >          array['push'] = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            var methodCallResult = arrayProto['push'].apply(array, arguments);</span>
<span class="cstat-no" title="statement not covered" >            observer.addChangeRecord({</span>
              type: 'splice',
              object: array,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >          array['reverse'] = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            var oldArray = array.slice();</span>
<span class="cstat-no" title="statement not covered" >            var methodCallResult = arrayProto['reverse'].apply(array, arguments);</span>
<span class="cstat-no" title="statement not covered" >            observer.reset(oldArray);</span>
<span class="cstat-no" title="statement not covered" >            return methodCallResult;</span>
          };
&nbsp;
<span class="cstat-no" title="statement not covered" >          array['shift'] = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            var methodCallResult = arrayProto['shift'].apply(array, arguments);</span>
<span class="cstat-no" title="statement not covered" >            observer.addChangeRecord({</span>
              type: 'delete',
              object: array,
              name: 0,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >          array['sort'] = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            var oldArray = array.slice();</span>
<span class="cstat-no" title="statement not covered" >            var methodCallResult = arrayProto['sort'].apply(array, arguments);</span>
<span class="cstat-no" title="statement not covered" >            observer.reset(oldArray);</span>
<span class="cstat-no" title="statement not covered" >            return methodCallResult;</span>
          };
&nbsp;
<span class="cstat-no" title="statement not covered" >          array['splice'] = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            var methodCallResult = arrayProto['splice'].apply(array, arguments);</span>
<span class="cstat-no" title="statement not covered" >            observer.addChangeRecord({</span>
              type: 'splice',
              object: array,
              index: arguments[0],
...
&nbsp;
<span class="cstat-no" title="statement not covered" >          array['unshift'] = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            var methodCallResult = arrayProto['unshift'].apply(array, arguments);</span>
<span class="cstat-no" title="statement not covered" >            observer.addChangeRecord({</span>
              type: 'splice',
              object: array,
              index: 0,
...
&nbsp;
        ArrayObserveObserver.prototype.getLengthObserver = <span class="fstat-no" title="function not covered" >function getLengthObserver() {</span>
<span class="cstat-no" title="statement not covered" >          return this.lengthObserver || (this.lengthObserver = new CollectionLengthObserver(this.array));</span>
        };
&nbsp;
...
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (this.lengthObserver) {
<span class="cstat-no" title="statement not covered" >            this.lengthObserver.call(this.array.length);</span>
          }
        };
&nbsp;
