...
<html lang="en">
<head>
    <title>Code coverage report for src/array-change-records.js</title>
    <meta charset="utf-8">
...
<div class="header low">
    <h1>Code coverage report for <span class="entity">src/array-change-records.js</span></h1>
    <h2>
        Statements: <span class="metric">30.84% <small>(66 / 214)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">17.14% <small>(18 / 105)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">63.16% <small>(12 / 19)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">31.94% <small>(61 / 191)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; array-change-records.js</div>
</div>
<div class="body">
...
377
378
379</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function isIndex(s) {</span>
<span class="cstat-no" title="statement not covered" >    return +s === s &gt;&gt;&gt; 0;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function toNumber(s) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function intersect(start1, end1, start2, end2) {</span>
    // Disjoint
<span class="cstat-no" title="statement not covered" >    if (end1 &lt; start2 || end2 &lt; start1) <span class="cstat-no" title="statement not covered" >return -1;</span></span>
&nbsp;
    // Adjacent
<span class="cstat-no" title="statement not covered" >    if (end1 == start2 || end2 == start1) <span class="cstat-no" title="statement not covered" >return 0;</span></span>
&nbsp;
    // Non-zero intersect, span1 first
<span class="cstat-no" title="statement not covered" >    if (start1 &lt; start2) {</span>
<span class="cstat-no" title="statement not covered" >      if (end1 &lt; end2) <span class="cstat-no" title="statement not covered" >return end1 - start2; </span>// Overlap</span>
      else <span class="cstat-no" title="statement not covered" >return end2 - start2; </span>// Contained
    } else {
      // Non-zero intersect, span2 first
<span class="cstat-no" title="statement not covered" >      if (end2 &lt; end1) <span class="cstat-no" title="statement not covered" >return end2 - start1; </span>// Overlap</span>
      else <span class="cstat-no" title="statement not covered" >return end1 - start1; </span>// Contained
    }
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var current = splices[i];</span>
<span class="cstat-no" title="statement not covered" >      current.index += insertionOffset;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (inserted) <span class="cstat-no" title="statement not covered" >continue;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var intersectCount = intersect(splice.index, splice.index + splice.removed.length, current.index, current.index + current.addedCount);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (intersectCount &gt;= 0) {</span>
        // Merge the two splices
&nbsp;
<span class="cstat-no" title="statement not covered" >        splices.splice(i, 1);</span>
<span class="cstat-no" title="statement not covered" >        i--;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        insertionOffset -= current.addedCount - current.removed.length;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        splice.addedCount += current.addedCount - intersectCount;</span>
<span class="cstat-no" title="statement not covered" >        var deleteCount = splice.removed.length + current.removed.length - intersectCount;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!splice.addedCount &amp;&amp; !deleteCount) {</span>
          // merged splice is a noop. discard.
<span class="cstat-no" title="statement not covered" >          inserted = true;</span>
        } else {
<span class="cstat-no" title="statement not covered" >          var removed = current.removed;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (splice.index &lt; current.index) {</span>
            // some prefix of splice.removed is prepended to current.removed.
<span class="cstat-no" title="statement not covered" >            var prepend = splice.removed.slice(0, current.index - splice.index);</span>
<span class="cstat-no" title="statement not covered" >            Array.prototype.push.apply(prepend, removed);</span>
<span class="cstat-no" title="statement not covered" >            removed = prepend;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (splice.index + splice.removed.length &gt; current.index + current.addedCount) {</span>
            // some suffix of splice.removed is appended to current.removed.
<span class="cstat-no" title="statement not covered" >            var append = splice.removed.slice(current.index + current.addedCount - splice.index);</span>
<span class="cstat-no" title="statement not covered" >            Array.prototype.push.apply(removed, append);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          splice.removed = removed;</span>
<span class="cstat-no" title="statement not covered" >          if (current.index &lt; splice.index) {</span>
<span class="cstat-no" title="statement not covered" >            splice.index = current.index;</span>
          }
        }
      } else <span class="cstat-no" title="statement not covered" >if (splice.index &lt; current.index) {</span>
        // Insert splice here.
&nbsp;
<span class="cstat-no" title="statement not covered" >        inserted = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        splices.splice(i, 0, splice);</span>
<span class="cstat-no" title="statement not covered" >        i++;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var offset = splice.addedCount - splice.removed.length;</span>
<span class="cstat-no" title="statement not covered" >        current.index += offset;</span>
<span class="cstat-no" title="statement not covered" >        insertionOffset += offset;</span>
      }
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!inserted) splices.push(splice);
  }
&nbsp;
    ...
    for (var i = 0; i &lt; changeRecords.length; i++) {
      ...
      switch (record.type) {
        case 'splice':
          ...
          break;
<span class="branch-1 cbranch-no" title="branch not covered" >        case 'add':</span>
<span class="branch-2 cbranch-no" title="branch not covered" >        case 'update':</span>
<span class="branch-3 cbranch-no" title="branch not covered" >        case 'delete':</span>
<span class="cstat-no" title="statement not covered" >          if (!isIndex(record.name)) <span class="cstat-no" title="statement not covered" >continue;</span></span>
<span class="cstat-no" title="statement not covered" >          var index = toNumber(record.name);</span>
...
<span class="cstat-no" title="statement not covered" >          mergeSplice(splices, index, [record.oldValue], record.type === 'delete' ? 0 : 1);</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
<span class="branch-4 cbranch-no" title="branch not covered" >        default:</span>
<span class="cstat-no" title="statement not covered" >          console.error('Unexpected record type: ' + JSON.stringify(record));</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
      }
    }
&nbsp;
...
&nbsp;
    createInitialSplices(array, changeRecords).forEach(function (splice) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (splice.addedCount == 1 &amp;&amp; splice.removed.length == 1) {
<span class="cstat-no" title="statement not covered" >        if (splice.removed[0] !== array[splice.index]) <span class="cstat-no" title="statement not covered" >splices.push(splice);</span></span>
&nbsp;
  ...
  return {
    ...
    execute: function () {
      ...
      ArraySplice.prototype = {
        ...
        calcEditDistances: <span class="fstat-no" title="function not covered" >function calcEditDistances(current, currentStart, currentEnd, old, oldStart, oldEnd) {</span>
          // "Deletion" columns
...
<span class="cstat-no" title="statement not covered" >          var i, j, north, west;</span>
&nbsp;
          // "Addition" rows. Initialize null column.
<span class="cstat-no" title="statement not covered" >          for (i = 0; i &lt; rowCount; ++i) {</span>
...
&nbsp;
          // Initialize null row
<span class="cstat-no" title="statement not covered" >          for (j = 0; j &lt; columnCount; ++j) {</span>
<span class="cstat-no" title="statement not covered" >            distances[0][j] = j;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          for (i = 1; i &lt; rowCount; ++i) {</span>
<span class="cstat-no" title="statement not covered" >            for (j = 1; j &lt; columnCount; ++j) {</span>
<span class="cstat-no" title="statement not covered" >              if (this.equals(current[currentStart + j - 1], old[oldStart + i - 1])) <span class="cstat-no" title="statement not covered" >distances[i][j] = distances[i - 1][j - 1];e</span>lse {</span>
<span class="cstat-no" title="statement not covered" >                north = distances[i - 1][j] + 1;</span>
<span class="cstat-no" title="statement not covered" >                west = distances[i][j - 1] + 1;</span>
...
&nbsp;
        ...
        // matrix.
        spliceOperationsFromEditDistances: <span class="fstat-no" title="function not covered" >function spliceOperationsFromEditDistances(distances) {</span>
...
<span class="cstat-no" title="statement not covered" >            if (west &lt; north) <span class="cstat-no" title="statement not covered" >min = west &lt; northWest ? west : northWest;e</span>lse <span class="cstat-no" title="statement not covered" >min = north &lt; northWest ? north : northWest;</span></span>
&nbsp;
...
&nbsp;
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (currentStart == 0 &amp;&amp; oldStart == 0) prefixCount = this.sharedPrefix(current, old, minLength);
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (currentEnd == current.length &amp;&amp; oldEnd == old.length) suffixCount = this.sharedSuffix(current, old, minLength - prefixCount);
&nbsp;
          ...
          oldEnd -= suffixCount;
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (currentEnd - currentStart == 0 &amp;&amp; oldEnd - oldStart == 0) <span class="cstat-no" title="statement not covered" >return [];</span>
&nbsp;
...
&nbsp;
            return [splice];
          } else <span class="missing-if-branch" title="else path not taken" >E</span>if (oldStart == oldEnd) return [newSplice(currentStart, [], currentEnd - currentStart)];
&nbsp;
...
&nbsp;
        sharedPrefix: function sharedPrefix(current, old, searchLength) {
          for (var i = 0; i &lt; searchLength; ++i) <span class="cstat-no" title="statement not covered" >if (!this.equals(current[i], old[i])) <span class="cstat-no" title="statement not covered" >return i;</span></span>
          return searchLength;
        },
&nbsp;
        sharedSuffix: function sharedSuffix(current, old, searchLength) {
          ...
          var count = 0;
          while (count &lt; searchLength &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.equals(current[--index1], old[--index2]))</span> <span class="cstat-no" title="statement not covered" >count++;</span>
&nbsp;
          return count;
        },
&nbsp;
        calculateSplices: <span class="fstat-no" title="function not covered" >function calculateSplices(current, previous) {</span>
...
&nbsp;
        equals: <span class="fstat-no" title="function not covered" >function equals(currentValue, previousValue) {</span>
