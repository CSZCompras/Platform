...
<html lang="en">
<head>
    <title>Code coverage report for src/event-manager.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/event-manager.js</span></h1>
    <h2>
        Statements: <span class="metric">64.04% <small>(57 / 89)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">39.47% <small>(15 / 38)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">51.85% <small>(14 / 27)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">64.37% <small>(56 / 87)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; event-manager.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">4039</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4039</span>
<span class="cline-any cline-yes">4039</span>
<span class="cline-any cline-yes">4039</span>
...
&nbsp;
        DefaultEventStrategy.prototype.ensureDelegatedEvent = <span class="fstat-no" title="function not covered" >function ensureDelegatedEvent(eventName) {</span>
<span class="cstat-no" title="statement not covered" >          if (this.delegatedEvents[eventName]) {</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.delegatedEvents[eventName] = true;</span>
<span class="cstat-no" title="statement not covered" >          document.addEventListener(eventName, this.handleDelegatedEvent.bind(this), false);</span>
        };
&nbsp;
        DefaultEventStrategy.prototype.handleCallbackResult = <span class="fstat-no" title="function not covered" >function handleCallbackResult(result) {</span>};
&nbsp;
        DefaultEventStrategy.prototype.handleDelegatedEvent = <span class="fstat-no" title="function not covered" >function handleDelegatedEvent(event) {</span>
...
<span class="cstat-no" title="statement not covered" >          var target = event.target || event.srcElement,</span>
              callback;
&nbsp;
<span class="cstat-no" title="statement not covered" >          while (target &amp;&amp; !callback) {</span>
<span class="cstat-no" title="statement not covered" >            if (target.delegatedEvents) {</span>
<span class="cstat-no" title="statement not covered" >              callback = target.delegatedEvents[event.type];</span>
            }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (callback) {</span>
<span class="cstat-no" title="statement not covered" >            this.handleCallbackResult(callback(event));</span>
          }
        };
&nbsp;
        DefaultEventStrategy.prototype.createDirectEventCallback = <span class="fstat-no" title="function not covered" >function createDirectEventCallback(callback) {</span>
...
<span class="cstat-no" title="statement not covered" >            _this.handleCallbackResult(callback(event));</span>
          };
        };
&nbsp;
        DefaultEventStrategy.prototype.subscribeToDelegatedEvent = <span class="fstat-no" title="function not covered" >function subscribeToDelegatedEvent(target, targetEvent, callback) {</span>
<span class="cstat-no" title="statement not covered" >          var lookup = target.delegatedEvents || (target.delegatedEvents = {});</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.ensureDelegatedEvent(targetEvent);</span>
<span class="cstat-no" title="statement not covered" >          lookup[targetEvent] = callback;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          return <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            lookup[targetEvent] = null;</span>
          };
        };
&nbsp;
        DefaultEventStrategy.prototype.subscribeToDirectEvent = <span class="fstat-no" title="function not covered" >function subscribeToDirectEvent(target, targetEvent, callback) {</span>
<span class="cstat-no" title="statement not covered" >          var directEventCallback = this.createDirectEventCallback(callback);</span>
<span class="cstat-no" title="statement not covered" >          target.addEventListener(targetEvent, directEventCallback, false);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          return <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            target.removeEventListener(targetEvent, directEventCallback);</span>
          };
        };
&nbsp;
        DefaultEventStrategy.prototype.subscribe = <span class="fstat-no" title="function not covered" >function subscribe(target, targetEvent, callback, delegate) {</span>
<span class="cstat-no" title="statement not covered" >          if (delegate) {</span>
<span class="cstat-no" title="statement not covered" >            return this.subscribeToDelegatedEvent(target, targetEvent, callback);</span>
          } else {
<span class="cstat-no" title="statement not covered" >            return this.subscribeToDirectEvent(target, targetEvent, callback);</span>
          }
        };
&nbsp;
...
&nbsp;
        EventManager.prototype.registerElementHandler = <span class="fstat-no" title="function not covered" >function registerElementHandler(tagName, handler) {</span>
<span class="cstat-no" title="statement not covered" >          this.elementHandlerLookup[tagName.toLowerCase()] = handler;</span>
        };
&nbsp;
        EventManager.prototype.registerEventStrategy = <span class="fstat-no" title="function not covered" >function registerEventStrategy(eventName, strategy) {</span>
<span class="cstat-no" title="statement not covered" >          this.eventStrategyLookup[eventName] = strategy;</span>
        };
&nbsp;
        EventManager.prototype.getElementHandler = function getElementHandler(target, propertyName) {
          var tagName,
              lookup = this.elementHandlerLookup;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (target.tagName) {
...
&nbsp;
        EventManager.prototype.addEventListener = <span class="fstat-no" title="function not covered" >function addEventListener(target, targetEvent, callback, delegate) {</span>
<span class="cstat-no" title="statement not covered" >          return (this.eventStrategyLookup[targetEvent] || this.defaultEventStrategy).subscribe(target, targetEvent, callback, delegate);</span>
        };
&nbsp;
        return EventManager;
      })();
