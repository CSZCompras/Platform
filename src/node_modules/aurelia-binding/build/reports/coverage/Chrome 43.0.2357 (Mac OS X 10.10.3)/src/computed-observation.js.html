...
<html lang="en">
<head>
    <title>Code coverage report for src/computed-observation.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/computed-observation.js</span></h1>
    <h2>
        Statements: <span class="metric">94.74% <small>(54 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; computed-observation.js</div>
</div>
<div class="body">
...
&nbsp;
        ComputedPropertyObserver.prototype.evaluate = function evaluate() {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (this.oldValue === newValue) <span class="cstat-no" title="statement not covered" >return;</span>
...
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (this.oldValue === undefined) {
...
&nbsp;
          return function () {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (_this.callbacks.length &gt; 0) <span class="cstat-no" title="statement not covered" >return;</span>
