...
<html lang="en">
<head>
    <title>Code coverage report for src/name-expression.js</title>
    <meta charset="utf-8">
...
<div class="header low">
    <h1>Code coverage report for <span class="entity">src/name-expression.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; name-expression.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >        function NameExpression(name, mode) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, NameExpression);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.property = name;</span>
<span class="cstat-no" title="statement not covered" >          this.discrete = true;</span>
<span class="cstat-no" title="statement not covered" >          this.mode = mode.replace(/-([a-z])/g, <span class="fstat-no" title="function not covered" >function (m, w) {</span></span>
<span class="cstat-no" title="statement not covered" >            return w.toUpperCase();</span>
          });
        }
&nbsp;
        NameExpression.prototype.createBinding = <span class="fstat-no" title="function not covered" >function createBinding(target) {</span>
<span class="cstat-no" title="statement not covered" >          return new NameBinder(this.property, target, this.mode);</span>
        };
&nbsp;
...
&nbsp;
      NameBinder = (function () {
<span class="fstat-no" title="function not covered" >        function NameBinder(property, target, mode) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, NameBinder);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.property = property;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (mode === 'element') {</span>
<span class="cstat-no" title="statement not covered" >            this.target = target;</span>
          } else {
<span class="cstat-no" title="statement not covered" >            this.target = target[mode];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (this.target === undefined) {</span>
<span class="cstat-no" title="statement not covered" >              throw new Error('Attempted to reference "' + mode + '", but it was not found on the target element.');</span>
            } else {
<span class="cstat-no" title="statement not covered" >              this.target = this.target.executionContext || this.target;</span>
            }
          }
        }
&nbsp;
        NameBinder.prototype.bind = <span class="fstat-no" title="function not covered" >function bind(source) {</span>
...
<span class="cstat-no" title="statement not covered" >          source[this.property] = this.target;</span>
        };
&nbsp;
        NameBinder.prototype.unbind = <span class="fstat-no" title="function not covered" >function unbind() {</span>
<span class="cstat-no" title="statement not covered" >          this.source[this.property] = null;</span>
        };
&nbsp;
        return NameBinder;
      })();
