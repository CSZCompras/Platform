...
<html lang="en">
<head>
    <title>Code coverage report for src/element-observation.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/element-observation.js</span></h1>
    <h2>
        Statements: <span class="metric">95.44% <small>(230 / 241)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">82.11% <small>(78 / 95)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(50 / 50)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">95.82% <small>(229 / 239)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; element-observation.js</div>
</div>
<div class="body">
...
447
448
449</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
&nbsp;
        StyleObserver.prototype.flattenCss = function flattenCss(object) {
          ...
          for (var propertyName in object) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (object.hasOwnProperty(propertyName)) {
...
&nbsp;
        ValueAttributeObserver.prototype.subscribe = function subscribe(callback) {
          var that = this;
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.disposeHandler) {
...
&nbsp;
        SelectValueObserver.prototype.setValue = function setValue(newValue) {
          var _this = this;
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (newValue !== null &amp;&amp; newValue !== undefined &amp;&amp; this.element.multiple &amp;&amp; !Array.isArray(newValue)) {
<span class="cstat-no" title="statement not covered" >            throw new Error('Only null or Array instances can be bound to a multi-select.');</span>
          }
          <span class="missing-if-branch" title="if path not taken" >I</span>if (this.value === newValue) {
...
<span class="cstat-no" title="statement not covered" >            clear = true;</span>
...
&nbsp;
          ...
          while (i--) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (clear) {
...
&nbsp;
          if (!this.element.multiple) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (count === 0) {
...
&nbsp;
        SelectValueObserver.prototype.subscribe = function subscribe(callback) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.callbacks) {
            this.callbacks = [];
...
<span class="cstat-no" title="statement not covered" >            return;</span>
          ...
          // unsubscribe from old array.
          <span class="missing-if-branch" title="if path not taken" >I</span>if (this.arraySubscription) {
<span class="cstat-no" title="statement not covered" >            this.arraySubscription();</span>
<span class="cstat-no" title="statement not covered" >            this.arraySubscription = null;</span>
          }
          // subscribe to new array.
...
&nbsp;
          if (element.type === 'checkbox') {
            if (Array.isArray(value)) {
              ...
              } else <span class="missing-if-branch" title="else path not taken" >E</span>if (!element.checked &amp;&amp; index !== -1) {
          ...
          } else <span class="missing-if-branch" title="else path not taken" >E</span>if (element.checked) {
            value = elementValue;
          } else {
            // don't invoke callbacks.
<span class="cstat-no" title="statement not covered" >            return;</span>
