...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">75.79% <small>(191 / 252)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">56.64% <small>(64 / 113)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">97.06% <small>(33 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">75.42% <small>(178 / 236)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">System.register(['./lexer', './ast'], function (_export) {
  'use strict';
&nbsp;
...
&nbsp;
        Parser.prototype.parse = function parse(input) {
          input = input || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
&nbsp;
...
&nbsp;
          while (this.optional(';')) {
<span class="cstat-no" title="statement not covered" >            isChain = true;</span>
          }
&nbsp;
          while (this.index &lt; this.tokens.length) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.peek.text === ')' || this.peek.text === '}' || this.peek.text === ']') {
<span class="cstat-no" title="statement not covered" >              this.error('Unconsumed token ' + this.peek.text);</span>
            }
&nbsp;
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (isChain &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >expr instanceof ValueConverter)</span> {
<span class="cstat-no" title="statement not covered" >              this.error('cannot have a value converter in a chain');</span>
            }
          }
&nbsp;
          return expressions.length === 1 ? expressions[0] : <span class="branch-1 cbranch-no" title="branch not covered" >new Chain(expressions);</span>
        };
&nbsp;
...
&nbsp;
          while (this.optional('|')) {
<span class="cstat-no" title="statement not covered" >            var name = this.peek.text,</span>
                // TODO(kasperl): Restrict to identifier?
            args = [];
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.advance();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            while (this.optional(':')) {</span>
              // TODO(kasperl): Is this really supposed to be expressions?
<span class="cstat-no" title="statement not covered" >              args.push(this.parseExpression());</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            result = new ValueConverter(result, name, args, [result].concat(args));</span>
          }
&nbsp;
          return result;
        };
...
<span class="cstat-no" title="statement not covered" >            if (!result.isAssignable) {</span>
<span class="cstat-no" title="statement not covered" >              var end = this.index &lt; this.tokens.length ? this.peek.index : this.input.length;</span>
<span class="cstat-no" title="statement not covered" >              var expression = this.input.substring(start, end);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              this.error('Expression ' + expression + ' is not assignable');</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.expect('=');</span>
<span class="cstat-no" title="statement not covered" >            result = new Assign(result, this.parseConditional());</span>
          }
&nbsp;
          return result;
        };
...
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('?')) {
<span class="cstat-no" title="statement not covered" >            var yes = this.parseExpression();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!this.optional(':')) {</span>
<span class="cstat-no" title="statement not covered" >              var end = this.index &lt; this.tokens.length ? this.peek.index : this.input.length;</span>
<span class="cstat-no" title="statement not covered" >              var expression = this.input.substring(start, end);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              this.error('Conditional expression ' + expression + ' requires all 3 expressions');</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            var no = this.parseExpression();</span>
<span class="cstat-no" title="statement not covered" >            result = new Conditional(result, yes, no);</span>
          }
&nbsp;
          return result;
        };
...
&nbsp;
          while (this.optional('||')) {
<span class="cstat-no" title="statement not covered" >            result = new Binary('||', result, this.parseLogicalAnd());</span>
          }
&nbsp;
          return result;
        };
...
&nbsp;
          while (this.optional('&amp;&amp;')) {
<span class="cstat-no" title="statement not covered" >            result = new Binary('&amp;&amp;', result, this.parseEquality());</span>
          }
&nbsp;
          return result;
        };
...
&nbsp;
          while (true) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('==')) {
<span class="cstat-no" title="statement not covered" >              result = new Binary('==', result, this.parseRelational());</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('!=')) {
<span class="cstat-no" title="statement not covered" >              result = new Binary('!=', result, this.parseRelational());</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('===')) {
<span class="cstat-no" title="statement not covered" >              result = new Binary('===', result, this.parseRelational());</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('!==')) {
...
&nbsp;
          while (true) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('&lt;')) {
<span class="cstat-no" title="statement not covered" >              result = new Binary('&lt;', result, this.parseAdditive());</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('&gt;')) {
<span class="cstat-no" title="statement not covered" >              result = new Binary('&gt;', result, this.parseAdditive());</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('&lt;=')) {
<span class="cstat-no" title="statement not covered" >              result = new Binary('&lt;=', result, this.parseAdditive());</span>
...
&nbsp;
          while (true) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('+')) {
<span class="cstat-no" title="statement not covered" >              result = new Binary('+', result, this.parseMultiplicative());</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('-')) {
<span class="cstat-no" title="statement not covered" >              result = new Binary('-', result, this.parseMultiplicative());</span>
            } else {
              return result;
...
&nbsp;
          while (true) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('*')) {
<span class="cstat-no" title="statement not covered" >              result = new Binary('*', result, this.parsePrefix());</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('%')) {
<span class="cstat-no" title="statement not covered" >              result = new Binary('%', result, this.parsePrefix());</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('/')) {
<span class="cstat-no" title="statement not covered" >              result = new Binary('/', result, this.parsePrefix());</span>
...
&nbsp;
        ParserImplementation.prototype.parsePrefix = function parsePrefix() {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('+')) {
<span class="cstat-no" title="statement not covered" >            return this.parsePrefix(); </span>// TODO(kasperl): This is different than the original parser.
          } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('-')) {
<span class="cstat-no" title="statement not covered" >            return new Binary('-', new LiteralPrimitive(0), this.parsePrefix());</span>
          } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('!')) {
<span class="cstat-no" title="statement not covered" >            return new PrefixNot('!', this.parsePrefix());</span>
          } else {
...
&nbsp;
              <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('(')) {
<span class="cstat-no" title="statement not covered" >                var args = this.parseExpressionList(')');</span>
<span class="cstat-no" title="statement not covered" >                this.expect(')');</span>
<span class="cstat-no" title="statement not covered" >                result = new CallMember(result, name, args);</span>
              } else {
...
<span class="cstat-no" title="statement not covered" >              var args = this.parseExpressionList(')');</span>
<span class="cstat-no" title="statement not covered" >              this.expect(')');</span>
<span class="cstat-no" title="statement not covered" >              result = new CallFunction(result, args);</span>
            } else {
              return result;
            }
          }
...
&nbsp;
        ParserImplementation.prototype.parsePrimary = function parsePrimary() {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('(')) {
<span class="cstat-no" title="statement not covered" >            var result = this.parseExpression();</span>
<span class="cstat-no" title="statement not covered" >            this.expect(')');</span>
<span class="cstat-no" title="statement not covered" >            return result;</span>
          } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('null') || this.optional('undefined')) {
<span class="cstat-no" title="statement not covered" >            return new LiteralPrimitive(null);</span>
          } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('true')) {
<span class="cstat-no" title="statement not covered" >            return new LiteralPrimitive(true);</span>
          } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.optional('false')) {
<span class="cstat-no" title="statement not covered" >            return new LiteralPrimitive(false);</span>
          } else if (this.optional('[')) {
          ...
          } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.peek.value != null) {
            var value = this.peek.value;
            this.advance();
            return isNaN(value) ? new LiteralString(value) : new LiteralPrimitive(value);
          } else <span class="cstat-no" title="statement not covered" >if (this.index &gt;= this.tokens.length) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error('Unexpected end of expression: ' + this.input);</span>
          } else {
<span class="cstat-no" title="statement not covered" >            this.error('Unexpected token ' + this.peek.text);</span>
          }
        };
&nbsp;
...
&nbsp;
          this.expect('{');
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (this.peek.text !== '}') {
            do {
              // TODO(kasperl): Stricter checking. Only allow identifiers
              // and strings as keys. Maybe also keywords?
              var value = this.peek.value;
              keys.push(typeof value === 'string' ? <span class="branch-0 cbranch-no" title="branch not covered" >value </span>: this.peek.text);
&nbsp;
              this.advance();
              this.expect(':');
&nbsp;
...
&nbsp;
        ParserImplementation.prototype.parseExpressionList = function parseExpressionList(terminator) {
          var result = [];
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (this.peek.text != terminator) {
            do {
...
&nbsp;
        ParserImplementation.prototype.expect = function expect(text) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (this.peek.text === text) {
            this.advance();
          } else {
<span class="cstat-no" title="statement not covered" >            this.error('Missing expected ' + text);</span>
          }
        };
&nbsp;
...
&nbsp;
        ParserImplementation.prototype.error = <span class="fstat-no" title="function not covered" >function error(message) {</span>
<span class="cstat-no" title="statement not covered" >          var location = this.index &lt; this.tokens.length ? 'at column ' + (this.tokens[this.index].index + 1) + ' in' : 'at the end of the expression';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          throw new Error('Parser Error: ' + message + ' ' + location + ' [' + this.input + ']');</span>
        };
&nbsp;
