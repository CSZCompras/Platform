...
<html lang="en">
<head>
    <title>Code coverage report for src/access-keyed-observer.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/access-keyed-observer.js</span></h1>
    <h2>
        Statements: <span class="metric">81.03% <small>(47 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">73.33% <small>(22 / 30)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">92.86% <small>(13 / 14)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">82.14% <small>(46 / 56)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; access-keyed-observer.js</div>
</div>
<div class="body">
...
&nbsp;
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (object instanceof Object) {
...
&nbsp;
        AccessKeyedObserver.prototype.dispose = <span class="fstat-no" title="function not covered" >function dispose() {</span>
<span class="cstat-no" title="statement not covered" >          this.objectInfo = null;</span>
<span class="cstat-no" title="statement not covered" >          this.keyInfo = null;</span>
<span class="cstat-no" title="statement not covered" >          this.evaluate = null;</span>
<span class="cstat-no" title="statement not covered" >          this.observerLocator = null;</span>
<span class="cstat-no" title="statement not covered" >          if (this.disposeObject) {</span>
<span class="cstat-no" title="statement not covered" >            this.disposeObject();</span>
          }
<span class="cstat-no" title="statement not covered" >          if (this.disposeKey) {</span>
<span class="cstat-no" title="statement not covered" >            this.disposeKey();</span>
          }
<span class="cstat-no" title="statement not covered" >          if (this.disposeProperty) {</span>
<span class="cstat-no" title="statement not covered" >            this.disposeProperty();</span>
          }
        };
&nbsp;
