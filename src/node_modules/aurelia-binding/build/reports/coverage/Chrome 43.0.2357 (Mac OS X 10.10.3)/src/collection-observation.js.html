...
<html lang="en">
<head>
    <title>Code coverage report for src/collection-observation.js</title>
    <meta charset="utf-8">
...
<div class="header low">
    <h1>Code coverage report for <span class="entity">src/collection-observation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; collection-observation.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">System.register(['./array-change-records', './map-change-records'], function (_export) {
  'use strict';
&nbsp;
...
<span class="fstat-no" title="function not covered" >        function ModifyCollectionObserver(taskQueue, collection) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, ModifyCollectionObserver);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.taskQueue = taskQueue;</span>
<span class="cstat-no" title="statement not covered" >          this.queued = false;</span>
<span class="cstat-no" title="statement not covered" >          this.callbacks = [];</span>
<span class="cstat-no" title="statement not covered" >          this.changeRecords = [];</span>
<span class="cstat-no" title="statement not covered" >          this.oldCollection = null;</span>
<span class="cstat-no" title="statement not covered" >          this.collection = collection;</span>
<span class="cstat-no" title="statement not covered" >          this.lengthPropertyName = collection instanceof Map ? 'size' : 'length';</span>
        }
&nbsp;
        ModifyCollectionObserver.prototype.subscribe = <span class="fstat-no" title="function not covered" >function subscribe(callback) {</span>
<span class="cstat-no" title="statement not covered" >          var callbacks = this.callbacks;</span>
...
<span class="cstat-no" title="statement not covered" >            callbacks.splice(callbacks.indexOf(callback), 1);</span>
          };
        };
&nbsp;
        ModifyCollectionObserver.prototype.addChangeRecord = <span class="fstat-no" title="function not covered" >function addChangeRecord(changeRecord) {</span>
<span class="cstat-no" title="statement not covered" >          if (this.callbacks.length === 0 &amp;&amp; !this.lengthObserver) {</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.changeRecords.push(changeRecord);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (!this.queued) {</span>
<span class="cstat-no" title="statement not covered" >            this.queued = true;</span>
<span class="cstat-no" title="statement not covered" >            this.taskQueue.queueMicroTask(this);</span>
          }
        };
&nbsp;
        ModifyCollectionObserver.prototype.reset = <span class="fstat-no" title="function not covered" >function reset(oldCollection) {</span>
<span class="cstat-no" title="statement not covered" >          if (!this.callbacks.length) {</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.oldCollection = oldCollection;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (!this.queued) {</span>
<span class="cstat-no" title="statement not covered" >            this.queued = true;</span>
<span class="cstat-no" title="statement not covered" >            this.taskQueue.queueMicroTask(this);</span>
...
&nbsp;
        ModifyCollectionObserver.prototype.getLengthObserver = <span class="fstat-no" title="function not covered" >function getLengthObserver() {</span>
<span class="cstat-no" title="statement not covered" >          return this.lengthObserver || (this.lengthObserver = new CollectionLengthObserver(this.collection));</span>
        };
&nbsp;
        ModifyCollectionObserver.prototype.call = <span class="fstat-no" title="function not covered" >function call() {</span>
<span class="cstat-no" title="statement not covered" >          var callbacks = this.callbacks,</span>
              i = callbacks.length,
...
<span class="cstat-no" title="statement not covered" >            if (oldCollection) {</span>
              // TODO (martingust) we might want to refactor this to a common, independent of collection type, way of getting the records
<span class="cstat-no" title="statement not covered" >              if (this.collection instanceof Map) {</span>
<span class="cstat-no" title="statement not covered" >                records = getChangeRecords(oldCollection);</span>
              } else {
                //we might need to combine this with existing change records....
<span class="cstat-no" title="statement not covered" >                records = calcSplices(this.collection, 0, this.collection.length, oldCollection, 0, oldCollection.length);</span>
              }
            } else {
<span class="cstat-no" title="statement not covered" >              if (this.collection instanceof Map) {</span>
<span class="cstat-no" title="statement not covered" >                records = changeRecords;</span>
              } else {
<span class="cstat-no" title="statement not covered" >                records = projectArraySplices(this.collection, changeRecords);</span>
              }
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            while (i--) {</span>
<span class="cstat-no" title="statement not covered" >              callbacks[i](records);</span>
            }
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (this.lengthObserver) {</span>
<span class="cstat-no" title="statement not covered" >            this.lengthObserver.call(this.collection[this.lengthPropertyName]);</span>
          }
        };
&nbsp;
...
<span class="fstat-no" title="function not covered" >        function CollectionLengthObserver(collection) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, CollectionLengthObserver);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.collection = collection;</span>
<span class="cstat-no" title="statement not covered" >          this.callbacks = [];</span>
<span class="cstat-no" title="statement not covered" >          this.lengthPropertyName = collection instanceof Map ? 'size' : 'length';</span>
<span class="cstat-no" title="statement not covered" >          this.currentValue = collection[this.lengthPropertyName];</span>
        }
&nbsp;
        CollectionLengthObserver.prototype.getValue = <span class="fstat-no" title="function not covered" >function getValue() {</span>
<span class="cstat-no" title="statement not covered" >          return this.collection[this.lengthPropertyName];</span>
        };
&nbsp;
        CollectionLengthObserver.prototype.setValue = <span class="fstat-no" title="function not covered" >function setValue(newValue) {</span>
<span class="cstat-no" title="statement not covered" >          this.collection[this.lengthPropertyName] = newValue;</span>
        };
&nbsp;
        CollectionLengthObserver.prototype.subscribe = <span class="fstat-no" title="function not covered" >function subscribe(callback) {</span>
<span class="cstat-no" title="statement not covered" >          var callbacks = this.callbacks;</span>
<span class="cstat-no" title="statement not covered" >          callbacks.push(callback);</span>
<span class="cstat-no" title="statement not covered" >          return <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            callbacks.splice(callbacks.indexOf(callback), 1);</span>
...
&nbsp;
        CollectionLengthObserver.prototype.call = <span class="fstat-no" title="function not covered" >function call(newValue) {</span>
<span class="cstat-no" title="statement not covered" >          var callbacks = this.callbacks,</span>
              i = callbacks.length,
              oldValue = this.currentValue;
&nbsp;
<span class="cstat-no" title="statement not covered" >          while (i--) {</span>
<span class="cstat-no" title="statement not covered" >            callbacks[i](newValue, oldValue);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.currentValue = newValue;</span>
        };
&nbsp;
