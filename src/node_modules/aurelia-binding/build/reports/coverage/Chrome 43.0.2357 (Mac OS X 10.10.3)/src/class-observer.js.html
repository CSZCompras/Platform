...
<html lang="en">
<head>
    <title>Code coverage report for src/class-observer.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/class-observer.js</span></h1>
    <h2>
        Statements: <span class="metric">94.87% <small>(37 / 39)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; class-observer.js</div>
</div>
<div class="body">
...
&nbsp;
        ClassObserver.prototype.subscribe = <span class="fstat-no" title="function not covered" >function subscribe(callback) {</span>
<span class="cstat-no" title="statement not covered" >          throw new Error('Observation of a "' + this.element.nodeName + '" element\'s "class" property is not supported.');</span>
        };
&nbsp;
