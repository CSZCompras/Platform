...
<html lang="en">
<head>
    <title>Code coverage report for src/map-observation.js</title>
    <meta charset="utf-8">
...
<div class="header low">
    <h1>Code coverage report for <span class="entity">src/map-observation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; map-observation.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">System.register(['core-js', './map-change-records', './collection-observation'], function (_export) {
  'use strict';
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function getMapObserver(taskQueue, map) {</span>
<span class="cstat-no" title="statement not covered" >    return ModifyMapObserver.create(taskQueue, map);</span>
  }
&nbsp;
  return {
...
<span class="fstat-no" title="function not covered" >        function ModifyMapObserver(taskQueue, map) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, ModifyMapObserver);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _ModifyCollectionObserver.call(this, taskQueue, map);</span>
        }
&nbsp;
        _inherits(ModifyMapObserver, _ModifyCollectionObserver);
&nbsp;
        ModifyMapObserver.create = <span class="fstat-no" title="function not covered" >function create(taskQueue, map) {</span>
<span class="cstat-no" title="statement not covered" >          var observer = new ModifyMapObserver(taskQueue, map);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          map['set'] = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            var oldValue = map.get(arguments[0]);</span>
<span class="cstat-no" title="statement not covered" >            var type = oldValue ? 'update' : 'add';</span>
<span class="cstat-no" title="statement not covered" >            var methodCallResult = mapProto['set'].apply(map, arguments);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >          map['delete'] = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            var oldValue = map.get(arguments[0]);</span>
<span class="cstat-no" title="statement not covered" >            var methodCallResult = mapProto['delete'].apply(map, arguments);</span>
<span class="cstat-no" title="statement not covered" >            observer.addChangeRecord({</span>
              type: 'delete',
              object: map,
              key: arguments[0],
...
&nbsp;
<span class="cstat-no" title="statement not covered" >          map['clear'] = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            var methodCallResult = mapProto['clear'].apply(map, arguments);</span>
<span class="cstat-no" title="statement not covered" >            observer.addChangeRecord({</span>
              type: 'clear',
              object: map
            });
