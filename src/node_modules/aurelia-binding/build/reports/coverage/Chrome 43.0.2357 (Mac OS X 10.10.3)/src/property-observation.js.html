...
<html lang="en">
<head>
    <title>Code coverage report for src/property-observation.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/property-observation.js</span></h1>
    <h2>
        Statements: <span class="metric">93.37% <small>(169 / 181)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">75% <small>(39 / 52)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">93.75% <small>(30 / 32)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">94.83% <small>(165 / 174)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; property-observation.js</div>
</div>
<div class="body">
...
&nbsp;
        SetterObserver.prototype.getValue = <span class="fstat-no" title="function not covered" >function getValue() {</span>
<span class="cstat-no" title="statement not covered" >          return this.obj[this.propertyName];</span>
        };
&nbsp;
        SetterObserver.prototype.setValue = <span class="fstat-no" title="function not covered" >function setValue(newValue) {</span>
<span class="cstat-no" title="statement not covered" >          this.obj[this.propertyName] = newValue;</span>
        };
&nbsp;
...
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (oldValue !== newValue) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.queued) {
...
&nbsp;
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (callbacks.count = 0) {
<span class="cstat-no" title="statement not covered" >            callbacks.oldValue = null;</span>
<span class="cstat-no" title="statement not covered" >            this.callbacks[propertyName] = null;</span>
          }
&nbsp;
          this.callbackCount--;
          if (this.callbackCount === 0) {
...
&nbsp;
        OoObjectObserver.prototype.getObserver = function getObserver(propertyName, descriptor) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!propertyObserver) {
            if (descriptor) {
...
<span class="cstat-no" title="statement not covered" >              callback = _iterator[_i++];</span>
            } else {
              _i = _iterator.next();
              if (_i.done) break;
              callback = _i.value;
...
&nbsp;
          ...
          for (var _iterator2 = this.callbackMap.keys(), _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (_isArray2) {
...
<span class="cstat-no" title="statement not covered" >              callback = _iterator2[_i2++];</span>
            } else {
              _i2 = _iterator2.next();
              if (_i2.done) break;
              callback = _i2.value;
...
&nbsp;
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.subscription) {
