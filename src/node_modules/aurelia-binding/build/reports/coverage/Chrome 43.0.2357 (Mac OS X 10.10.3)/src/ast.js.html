...
<div class="header low">
    ...
    <h2>
        Statements: <span class="metric">49.16% <small>(291 / 592)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">18.79% <small>(31 / 165)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">43.94% <small>(58 / 132)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">49.23% <small>(286 / 581)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
1209
1210
1211</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">System.register(['./path-observer', './composite-observer', './access-keyed-observer'], function (_export) {
  'use strict';
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      evalListCache.push([]);</span>
    }
&nbsp;
...
<span class="fstat-no" title="function not covered" >  function autoConvertAdd(a, b) {</span>
...
<span class="cstat-no" title="statement not covered" >        return a + b.toString();</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (typeof a != 'string' &amp;&amp; typeof b == 'string') {</span>
<span class="cstat-no" title="statement not covered" >        return a.toString() + b;</span>
      }
&nbsp;
...
&nbsp;
  function ensureFunctionFromMap(obj, name) {
    var func = obj[name];
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof func === 'function') {
      return func;
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (func === null) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Undefined function ' + name);</span>
    } else {
...
&nbsp;
  function getKeyed(obj, key) {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (obj) {
      return obj[key];
    } else <span class="cstat-no" title="statement not covered" >if (obj === null) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Accessing null object');</span>
    } else {
...
&nbsp;
        Expression.prototype.evaluate = <span class="fstat-no" title="function not covered" >function evaluate() {</span>
<span class="cstat-no" title="statement not covered" >          throw new Error('Cannot evaluate ' + this);</span>
        };
&nbsp;
        Expression.prototype.assign = <span class="fstat-no" title="function not covered" >function assign() {</span>
<span class="cstat-no" title="statement not covered" >          throw new Error('Cannot assign to ' + this);</span>
        };
&nbsp;
        Expression.prototype.toString = <span class="fstat-no" title="function not covered" >function toString() {</span>
<span class="cstat-no" title="statement not covered" >          return Unparser.unparse(this);</span>
        };
&nbsp;
        return Expression;
      })();
...
<span class="fstat-no" title="function not covered" >        function Chain(expressions) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, Chain);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _Expression.call(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.expressions = expressions;</span>
<span class="cstat-no" title="statement not covered" >          this.isChain = true;</span>
        }
&nbsp;
        _inherits(Chain, _Expression);
&nbsp;
        Chain.prototype.evaluate = <span class="fstat-no" title="function not covered" >function evaluate(scope, valueConverters) {</span>
...
<span class="cstat-no" title="statement not covered" >            last = expressions[i].evaluate(scope, valueConverters);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (last !== null) {</span>
<span class="cstat-no" title="statement not covered" >              result = last;</span>
            }
          }
&nbsp;
...
&nbsp;
        Chain.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitChain(this);</span>
        };
&nbsp;
        return Chain;
      })(Expression);
...
<span class="fstat-no" title="function not covered" >        function ValueConverter(expression, name, args, allArgs) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, ValueConverter);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _Expression2.call(this);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          this.allArgs = allArgs;</span>
        }
&nbsp;
        _inherits(ValueConverter, _Expression2);
&nbsp;
        ValueConverter.prototype.evaluate = <span class="fstat-no" title="function not covered" >function evaluate(scope, valueConverters) {</span>
<span class="cstat-no" title="statement not covered" >          var converter = valueConverters(this.name);</span>
<span class="cstat-no" title="statement not covered" >          if (!converter) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error('No ValueConverter named "' + this.name + '" was found!');</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          if ('toView' in converter) {</span>
<span class="cstat-no" title="statement not covered" >            return converter.toView.apply(converter, evalList(scope, this.allArgs, valueConverters));</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          return this.allArgs[0].evaluate(scope, valueConverters);</span>
        };
&nbsp;
        ValueConverter.prototype.assign = <span class="fstat-no" title="function not covered" >function assign(scope, value, valueConverters) {</span>
<span class="cstat-no" title="statement not covered" >          var converter = valueConverters(this.name);</span>
<span class="cstat-no" title="statement not covered" >          if (!converter) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error('No ValueConverter named "' + this.name + '" was found!');</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          if ('fromView' in converter) {</span>
<span class="cstat-no" title="statement not covered" >            value = converter.fromView.apply(converter, [value].concat(evalList(scope, this.args, valueConverters)));</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          return this.allArgs[0].assign(scope, value, valueConverters);</span>
        };
&nbsp;
        ValueConverter.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitValueConverter(this);</span>
        };
&nbsp;
        ValueConverter.prototype.connect = <span class="fstat-no" title="function not covered" >function connect(binding, scope) {</span>
...
<span class="cstat-no" title="statement not covered" >          var observer,</span>
              ...
              expInfo;
&nbsp;
<span class="cstat-no" title="statement not covered" >          for (i = 0, ii = this.allArgs.length; i &lt; ii; ++i) {</span>
<span class="cstat-no" title="statement not covered" >            exp = this.allArgs[i];</span>
<span class="cstat-no" title="statement not covered" >            expInfo = exp.connect(binding, scope);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (expInfo.observer) {</span>
<span class="cstat-no" title="statement not covered" >              childObservers.push(expInfo.observer);</span>
            }
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (childObservers.length) {</span>
<span class="cstat-no" title="statement not covered" >            observer = new CompositeObserver(childObservers, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >              return _this.evaluate(scope, binding.valueConverterLookupFunction);</span>
            });
          }
&nbsp;
...
<span class="fstat-no" title="function not covered" >        function Assign(target, value) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, Assign);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _Expression3.call(this);</span>
&nbsp;
...
&nbsp;
        Assign.prototype.evaluate = <span class="fstat-no" title="function not covered" >function evaluate(scope, valueConverters) {</span>
<span class="cstat-no" title="statement not covered" >          return this.target.assign(scope, this.value.evaluate(scope, valueConverters));</span>
        };
&nbsp;
        Assign.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(vistor) {</span>
<span class="cstat-no" title="statement not covered" >          vistor.visitAssign(this);</span>
        };
&nbsp;
        Assign.prototype.connect = <span class="fstat-no" title="function not covered" >function connect(binding, scope) {</span>
<span class="cstat-no" title="statement not covered" >          return { value: this.evaluate(scope, binding.valueConverterLookupFunction) };</span>
        };
&nbsp;
        return Assign;
      })(Expression);
...
<span class="fstat-no" title="function not covered" >        function Conditional(condition, yes, no) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, Conditional);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _Expression4.call(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.condition = condition;</span>
<span class="cstat-no" title="statement not covered" >          this.yes = yes;</span>
<span class="cstat-no" title="statement not covered" >          this.no = no;</span>
        }
&nbsp;
        _inherits(Conditional, _Expression4);
&nbsp;
        Conditional.prototype.evaluate = <span class="fstat-no" title="function not covered" >function evaluate(scope, valueConverters) {</span>
<span class="cstat-no" title="statement not covered" >          return !!this.condition.evaluate(scope) ? this.yes.evaluate(scope) : this.no.evaluate(scope);</span>
        };
&nbsp;
        Conditional.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitConditional(this);</span>
        };
&nbsp;
        Conditional.prototype.connect = <span class="fstat-no" title="function not covered" >function connect(binding, scope) {</span>
<span class="cstat-no" title="statement not covered" >          var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          var conditionInfo = this.condition.connect(binding, scope),</span>
              yesInfo = this.yes.connect(binding, scope),
              noInfo = this.no.connect(binding, scope),
              childObservers = [],
              observer;
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (conditionInfo.observer) {</span>
<span class="cstat-no" title="statement not covered" >            childObservers.push(conditionInfo.observer);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (yesInfo.observer) {</span>
<span class="cstat-no" title="statement not covered" >            childObservers.push(yesInfo.observer);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (noInfo.observer) {</span>
<span class="cstat-no" title="statement not covered" >            childObservers.push(noInfo.observer);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (childObservers.length) {</span>
<span class="cstat-no" title="statement not covered" >            observer = new CompositeObserver(childObservers, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >              return _this2.evaluate(scope, binding.valueConverterLookupFunction);</span>
            });
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          return {</span>
...
&nbsp;
        AccessScope.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitAccessScope(this);</span>
        };
&nbsp;
...
&nbsp;
        AccessMember.prototype.evaluate = function evaluate(scope, valueConverters) {
          ...
          return instance === null || instance === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >instance </span>: instance[this.name];
        };
&nbsp;
        AccessMember.prototype.assign = function assign(scope, value) {
          var instance = this.object.evaluate(scope);
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (instance === null || instance === undefined) {
<span class="cstat-no" title="statement not covered" >            instance = {};</span>
<span class="cstat-no" title="statement not covered" >            this.object.assign(scope, instance);</span>
          }
&nbsp;
          return instance[this.name] = value;
        };
&nbsp;
        AccessMember.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitAccessMember(this);</span>
        };
&nbsp;
...
&nbsp;
          var info = this.object.connect(binding, scope),
              ...
              observer;
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (objectObserver) {
...
<span class="cstat-no" title="statement not covered" >            observer = binding.getObserver(objectInstance, this.name);</span>
          }
&nbsp;
          return {
            value: objectInstance == null ? <span class="branch-0 cbranch-no" title="branch not covered" >null </span>: objectInstance[this.name], //TODO: use prop abstraction
            observer: observer
          };
        };
&nbsp;
...
&nbsp;
        AccessKeyed.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitAccessKeyed(this);</span>
        };
&nbsp;
...
&nbsp;
        CallScope.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitCallScope(this);</span>
        };
&nbsp;
        CallScope.prototype.connect = <span class="fstat-no" title="function not covered" >function connect(binding, scope) {</span>
...
<span class="cstat-no" title="statement not covered" >          var observer,</span>
              ...
              expInfo;
&nbsp;
<span class="cstat-no" title="statement not covered" >          for (i = 0, ii = this.args.length; i &lt; ii; ++i) {</span>
<span class="cstat-no" title="statement not covered" >            exp = this.args[i];</span>
<span class="cstat-no" title="statement not covered" >            expInfo = exp.connect(binding, scope);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (expInfo.observer) {</span>
<span class="cstat-no" title="statement not covered" >              childObservers.push(expInfo.observer);</span>
...
<span class="cstat-no" title="statement not covered" >          if (childObservers.length) {</span>
<span class="cstat-no" title="statement not covered" >            observer = new CompositeObserver(childObservers, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >              return _this5.evaluate(scope, binding.valueConverterLookupFunction);</span>
            });
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          return {</span>
...
<span class="fstat-no" title="function not covered" >        function CallMember(object, name, args) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, CallMember);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _Expression9.call(this);</span>
&nbsp;
...
&nbsp;
        CallMember.prototype.evaluate = <span class="fstat-no" title="function not covered" >function evaluate(scope, valueConverters, args) {</span>
<span class="cstat-no" title="statement not covered" >          var instance = this.object.evaluate(scope, valueConverters);</span>
<span class="cstat-no" title="statement not covered" >          args = args || evalList(scope, this.args, valueConverters);</span>
<span class="cstat-no" title="statement not covered" >          return ensureFunctionFromMap(instance, this.name).apply(instance, args);</span>
        };
&nbsp;
        CallMember.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitCallMember(this);</span>
        };
&nbsp;
        CallMember.prototype.connect = <span class="fstat-no" title="function not covered" >function connect(binding, scope) {</span>
...
<span class="cstat-no" title="statement not covered" >          var observer,</span>
              ...
              expInfo;
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (objectInfo.observer) {</span>
<span class="cstat-no" title="statement not covered" >            childObservers.push(objectInfo.observer);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          for (i = 0, ii = this.args.length; i &lt; ii; ++i) {</span>
<span class="cstat-no" title="statement not covered" >            exp = this.args[i];</span>
...
<span class="cstat-no" title="statement not covered" >          if (childObservers.length) {</span>
<span class="cstat-no" title="statement not covered" >            observer = new CompositeObserver(childObservers, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >              return _this6.evaluate(scope, binding.valueConverterLookupFunction);</span>
            });
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          return {</span>
...
<span class="fstat-no" title="function not covered" >        function CallFunction(func, args) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, CallFunction);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _Expression10.call(this);</span>
&nbsp;
...
&nbsp;
        CallFunction.prototype.evaluate = <span class="fstat-no" title="function not covered" >function evaluate(scope, valueConverters, args) {</span>
<span class="cstat-no" title="statement not covered" >          var func = this.func.evaluate(scope, valueConverters);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (typeof func !== 'function') {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error('' + this.func + ' is not a function');</span>
          } else {
<span class="cstat-no" title="statement not covered" >            return func.apply(null, args || evalList(scope, this.args, valueConverters));</span>
          }
        };
&nbsp;
        CallFunction.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitCallFunction(this);</span>
        };
&nbsp;
        CallFunction.prototype.connect = <span class="fstat-no" title="function not covered" >function connect(binding, scope) {</span>
...
<span class="cstat-no" title="statement not covered" >          var observer,</span>
              ...
              expInfo;
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (funcInfo.observer) {</span>
<span class="cstat-no" title="statement not covered" >            childObservers.push(funcInfo.observer);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          for (i = 0, ii = this.args.length; i &lt; ii; ++i) {</span>
<span class="cstat-no" title="statement not covered" >            exp = this.args[i];</span>
...
<span class="cstat-no" title="statement not covered" >          if (childObservers.length) {</span>
<span class="cstat-no" title="statement not covered" >            observer = new CompositeObserver(childObservers, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >              return _this7.evaluate(scope, binding.valueConverterLookupFunction);</span>
            });
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          return {</span>
...
<span class="fstat-no" title="function not covered" >        function Binary(operation, left, right) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, Binary);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _Expression11.call(this);</span>
&nbsp;
...
&nbsp;
        Binary.prototype.evaluate = <span class="fstat-no" title="function not covered" >function evaluate(scope, valueConverters) {</span>
<span class="cstat-no" title="statement not covered" >          var left = this.left.evaluate(scope);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          switch (this.operation) {</span>
            case '&amp;&amp;':
<span class="cstat-no" title="statement not covered" >              return left &amp;&amp; this.right.evaluate(scope);</span>
            case '||':
<span class="cstat-no" title="statement not covered" >              return left || this.right.evaluate(scope);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          var right = this.right.evaluate(scope);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          switch (this.operation) {</span>
            case '==':
...
<span class="cstat-no" title="statement not covered" >          if (left === null || right === null) {</span>
<span class="cstat-no" title="statement not covered" >            switch (this.operation) {</span>
              case '+':
<span class="cstat-no" title="statement not covered" >                if (left != null) <span class="cstat-no" title="statement not covered" >return left;</span></span>
<span class="cstat-no" title="statement not covered" >                if (right != null) <span class="cstat-no" title="statement not covered" >return right;</span></span>
<span class="cstat-no" title="statement not covered" >                return 0;</span>
              case '-':
<span class="cstat-no" title="statement not covered" >                if (left != null) <span class="cstat-no" title="statement not covered" >return left;</span></span>
<span class="cstat-no" title="statement not covered" >                if (right != null) <span class="cstat-no" title="statement not covered" >return 0 - right;</span></span>
<span class="cstat-no" title="statement not covered" >                return 0;</span>
            }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          switch (this.operation) {</span>
            case '+':
<span class="cstat-no" title="statement not covered" >              return autoConvertAdd(left, right);</span>
            case '-':
<span class="cstat-no" title="statement not covered" >              return left - right;</span>
            case '*':
<span class="cstat-no" title="statement not covered" >              return left * right;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >          throw new Error('Internal error [' + this.operation + '] not handled');</span>
        };
&nbsp;
        Binary.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitBinary(this);</span>
        };
&nbsp;
        Binary.prototype.connect = <span class="fstat-no" title="function not covered" >function connect(binding, scope) {</span>
<span class="cstat-no" title="statement not covered" >          var _this8 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          var leftInfo = this.left.connect(binding, scope),</span>
              rightInfo = this.right.connect(binding, scope),
              childObservers = [],
              observer;
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (leftInfo.observer) {</span>
<span class="cstat-no" title="statement not covered" >            childObservers.push(leftInfo.observer);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (rightInfo.observer) {</span>
<span class="cstat-no" title="statement not covered" >            childObservers.push(rightInfo.observer);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (childObservers.length) {</span>
<span class="cstat-no" title="statement not covered" >            observer = new CompositeObserver(childObservers, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >              return _this8.evaluate(scope, binding.valueConverterLookupFunction);</span>
            });
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          return {</span>
...
<span class="fstat-no" title="function not covered" >        function PrefixNot(operation, expression) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, PrefixNot);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _Expression12.call(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.operation = operation;</span>
<span class="cstat-no" title="statement not covered" >          this.expression = expression;</span>
        }
...
&nbsp;
        PrefixNot.prototype.evaluate = <span class="fstat-no" title="function not covered" >function evaluate(scope, valueConverters) {</span>
<span class="cstat-no" title="statement not covered" >          return !this.expression.evaluate(scope);</span>
        };
&nbsp;
        PrefixNot.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitPrefix(this);</span>
        };
&nbsp;
        PrefixNot.prototype.connect = <span class="fstat-no" title="function not covered" >function connect(binding, scope) {</span>
<span class="cstat-no" title="statement not covered" >          var _this9 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          var info = this.expression.connect(binding, scope),</span>
              observer;
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (info.observer) {</span>
<span class="cstat-no" title="statement not covered" >            observer = new CompositeObserver([info.observer], <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >              return _this9.evaluate(scope, binding.valueConverterLookupFunction);</span>
            });
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          return {</span>
...
&nbsp;
        LiteralPrimitive.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitLiteralPrimitive(this);</span>
        };
&nbsp;
...
&nbsp;
        LiteralString.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitLiteralString(this);</span>
        };
&nbsp;
...
&nbsp;
        LiteralArray.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitLiteralArray(this);</span>
        };
&nbsp;
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (expInfo.observer) {
<span class="cstat-no" title="statement not covered" >              childObservers.push(expInfo.observer);</span>
            }
&nbsp;
...
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (childObservers.length) {
<span class="cstat-no" title="statement not covered" >            observer = new CompositeObserver(childObservers, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >              return _this10.evaluate(scope, binding.valueConverterLookupFunction);</span>
            });
          }
&nbsp;
          return {
...
&nbsp;
        LiteralObject.prototype.accept = <span class="fstat-no" title="function not covered" >function accept(visitor) {</span>
<span class="cstat-no" title="statement not covered" >          visitor.visitLiteralObject(this);</span>
        };
&nbsp;
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (valueInfo.observer) {
<span class="cstat-no" title="statement not covered" >              childObservers.push(valueInfo.observer);</span>
            }
&nbsp;
...
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (childObservers.length) {
<span class="cstat-no" title="statement not covered" >            observer = new CompositeObserver(childObservers, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >              return _this11.evaluate(scope, binding.valueConverterLookupFunction);</span>
            });
          }
&nbsp;
          return {
...
&nbsp;
      Unparser = (function () {
<span class="fstat-no" title="function not covered" >        function Unparser(buffer) {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, Unparser);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.buffer = buffer;</span>
        }
&nbsp;
        Unparser.unparse = <span class="fstat-no" title="function not covered" >function unparse(expression) {</span>
<span class="cstat-no" title="statement not covered" >          var buffer = [],</span>
              visitor = new Unparser(buffer);
&nbsp;
<span class="cstat-no" title="statement not covered" >          expression.accept(visitor);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          return buffer.join('');</span>
        };
&nbsp;
        Unparser.prototype.write = <span class="fstat-no" title="function not covered" >function write(text) {</span>
<span class="cstat-no" title="statement not covered" >          this.buffer.push(text);</span>
        };
&nbsp;
        Unparser.prototype.writeArgs = <span class="fstat-no" title="function not covered" >function writeArgs(args) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >          for (i = 0, length = args.length; i &lt; length; ++i) {</span>
<span class="cstat-no" title="statement not covered" >            if (i !== 0) {</span>
<span class="cstat-no" title="statement not covered" >              this.write(',');</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            args[i].accept(this);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.write(')');</span>
        };
&nbsp;
        Unparser.prototype.visitChain = <span class="fstat-no" title="function not covered" >function visitChain(chain) {</span>
<span class="cstat-no" title="statement not covered" >          var expressions = chain.expressions,</span>
              length = expressions.length,
              i;
&nbsp;
<span class="cstat-no" title="statement not covered" >          for (i = 0; i &lt; length; ++i) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            expressions[i].accept(this);</span>
          }
        };
&nbsp;
        Unparser.prototype.visitValueConverter = <span class="fstat-no" title="function not covered" >function visitValueConverter(converter) {</span>
<span class="cstat-no" title="statement not covered" >          var args = converter.args,</span>
              length = args.length,
              i;
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.write('(');</span>
<span class="cstat-no" title="statement not covered" >          converter.expression.accept(this);</span>
<span class="cstat-no" title="statement not covered" >          this.write('|' + converter.name);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          for (i = 0; i &lt; length; ++i) {</span>
<span class="cstat-no" title="statement not covered" >            this.write(' :');</span>
<span class="cstat-no" title="statement not covered" >            args[i].accept(this);</span>
...
&nbsp;
        Unparser.prototype.visitAssign = <span class="fstat-no" title="function not covered" >function visitAssign(assign) {</span>
<span class="cstat-no" title="statement not covered" >          assign.target.accept(this);</span>
<span class="cstat-no" title="statement not covered" >          this.write('=');</span>
<span class="cstat-no" title="statement not covered" >          assign.value.accept(this);</span>
        };
&nbsp;
        Unparser.prototype.visitConditional = <span class="fstat-no" title="function not covered" >function visitConditional(conditional) {</span>
<span class="cstat-no" title="statement not covered" >          conditional.condition.accept(this);</span>
<span class="cstat-no" title="statement not covered" >          this.write('?');</span>
<span class="cstat-no" title="statement not covered" >          conditional.yes.accept(this);</span>
<span class="cstat-no" title="statement not covered" >          this.write(':');</span>
<span class="cstat-no" title="statement not covered" >          conditional.no.accept(this);</span>
        };
&nbsp;
        Unparser.prototype.visitAccessScope = <span class="fstat-no" title="function not covered" >function visitAccessScope(access) {</span>
<span class="cstat-no" title="statement not covered" >          this.write(access.name);</span>
        };
&nbsp;
        Unparser.prototype.visitAccessMember = <span class="fstat-no" title="function not covered" >function visitAccessMember(access) {</span>
<span class="cstat-no" title="statement not covered" >          access.object.accept(this);</span>
<span class="cstat-no" title="statement not covered" >          this.write('.' + access.name);</span>
        };
&nbsp;
        Unparser.prototype.visitAccessKeyed = <span class="fstat-no" title="function not covered" >function visitAccessKeyed(access) {</span>
<span class="cstat-no" title="statement not covered" >          access.object.accept(this);</span>
<span class="cstat-no" title="statement not covered" >          this.write('[');</span>
<span class="cstat-no" title="statement not covered" >          access.key.accept(this);</span>
<span class="cstat-no" title="statement not covered" >          this.write(']');</span>
        };
&nbsp;
        Unparser.prototype.visitCallScope = <span class="fstat-no" title="function not covered" >function visitCallScope(call) {</span>
<span class="cstat-no" title="statement not covered" >          this.write(call.name);</span>
<span class="cstat-no" title="statement not covered" >          this.writeArgs(call.args);</span>
        };
&nbsp;
        Unparser.prototype.visitCallFunction = <span class="fstat-no" title="function not covered" >function visitCallFunction(call) {</span>
<span class="cstat-no" title="statement not covered" >          call.func.accept(this);</span>
<span class="cstat-no" title="statement not covered" >          this.writeArgs(call.args);</span>
        };
&nbsp;
        Unparser.prototype.visitCallMember = <span class="fstat-no" title="function not covered" >function visitCallMember(call) {</span>
<span class="cstat-no" title="statement not covered" >          call.object.accept(this);</span>
<span class="cstat-no" title="statement not covered" >          this.write('.' + call.name);</span>
<span class="cstat-no" title="statement not covered" >          this.writeArgs(call.args);</span>
        };
&nbsp;
        Unparser.prototype.visitPrefix = <span class="fstat-no" title="function not covered" >function visitPrefix(prefix) {</span>
<span class="cstat-no" title="statement not covered" >          this.write('(' + prefix.operation);</span>
<span class="cstat-no" title="statement not covered" >          prefix.expression.accept(this);</span>
<span class="cstat-no" title="statement not covered" >          this.write(')');</span>
        };
&nbsp;
        Unparser.prototype.visitBinary = <span class="fstat-no" title="function not covered" >function visitBinary(binary) {</span>
<span class="cstat-no" title="statement not covered" >          this.write('(');</span>
<span class="cstat-no" title="statement not covered" >          binary.left.accept(this);</span>
<span class="cstat-no" title="statement not covered" >          this.write(binary.operation);</span>
<span class="cstat-no" title="statement not covered" >          binary.right.accept(this);</span>
<span class="cstat-no" title="statement not covered" >          this.write(')');</span>
        };
&nbsp;
        Unparser.prototype.visitLiteralPrimitive = <span class="fstat-no" title="function not covered" >function visitLiteralPrimitive(literal) {</span>
<span class="cstat-no" title="statement not covered" >          this.write('' + literal.value);</span>
        };
&nbsp;
        Unparser.prototype.visitLiteralArray = <span class="fstat-no" title="function not covered" >function visitLiteralArray(literal) {</span>
<span class="cstat-no" title="statement not covered" >          var elements = literal.elements,</span>
              length = elements.length,
              i;
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.write('[');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            elements[i].accept(this);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.write(']');</span>
        };
&nbsp;
        Unparser.prototype.visitLiteralObject = <span class="fstat-no" title="function not covered" >function visitLiteralObject(literal) {</span>
<span class="cstat-no" title="statement not covered" >          var keys = literal.keys,</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.write('\'' + keys[i] + '\':');</span>
<span class="cstat-no" title="statement not covered" >            values[i].accept(this);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.write('}');</span>
        };
&nbsp;
        Unparser.prototype.visitLiteralString = <span class="fstat-no" title="function not covered" >function visitLiteralString(literal) {</span>
<span class="cstat-no" title="statement not covered" >          var escaped = literal.value.replace(/'/g, '\'');</span>
<span class="cstat-no" title="statement not covered" >          this.write('\'' + escaped + '\'');</span>
        };
&nbsp;
        return Unparser;
      })();
