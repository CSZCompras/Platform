...
<html lang="en">
<head>
    <title>Code coverage report for src/environment.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/environment.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; environment.js</div>
</div>
<div class="body">
  ...
  return {
    ...
    execute: function () {
      hasObjectObserve = (function detectObjectObserve() {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof Object.observe !== 'function') {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (records.length !== 3) <span class="cstat-no" title="statement not covered" >return false;</span>
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (records[0].type != 'add' || records[1].type != 'update' || records[2].type != 'delete') {
<span class="cstat-no" title="statement not covered" >          return false;</span>
        }
&nbsp;
...
&nbsp;
      hasArrayObserve = (function detectArrayObserve() {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof Array.observe !== 'function') {
<span class="cstat-no" title="statement not covered" >          return false;</span>
        }
&nbsp;
        var records = [];
...
&nbsp;
        Object.deliverChangeRecords(callback);
        <span class="missing-if-branch" title="if path not taken" >I</span>if (records.length !== 2) <span class="cstat-no" title="statement not covered" >return false;</span>
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (records[0].type != 'splice' || records[1].type != 'splice') {
<span class="cstat-no" title="statement not covered" >          return false;</span>
        }
&nbsp;
