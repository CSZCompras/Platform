...
<html lang="en">
<head>
    <title>Code coverage report for src/map-change-records.js</title>
    <meta charset="utf-8">
...
<div class="header low">
    <h1>Code coverage report for <span class="entity">src/map-change-records.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; map-change-records.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function newRecord(type, object, key, oldValue) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function getChangeRecords(map) {</span>
<span class="cstat-no" title="statement not covered" >    var entries = [];</span>
<span class="cstat-no" title="statement not covered" >    for (var _iterator = map.keys(), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var key = _ref;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      entries.push(newRecord('added', map, key));</span>
    }
