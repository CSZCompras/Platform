...
<html lang="en">
<head>
    <title>Code coverage report for src/observer-locator.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/observer-locator.js</span></h1>
    <h2>
        Statements: <span class="metric">86.57% <small>(116 / 134)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">80.28% <small>(57 / 71)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">83.87% <small>(26 / 31)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">86.92% <small>(113 / 130)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; observer-locator.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4221</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4221</span>
...
<span class="cline-any cline-yes">6</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4019</span>
<span class="cline-any cline-yes">11</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4008</span>
<span class="cline-any cline-yes">14</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3994</span>
<span class="cline-any cline-yes">3994</span>
<span class="cline-any cline-yes">147</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3847</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">System.register(['aurelia-task-queue', './environment', './array-observation', './map-observation', './event-manager', './dirty-checking', './property-observation', './element-observation', './class-observer', 'aurelia-dependency-injection', './computed-observation', './svg'], function (_export) {
  'use strict';
&nbsp;
...
&nbsp;
  return {
    ...
    execute: function () {
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof Object.getPropertyDescriptor !== 'function') {
...
&nbsp;
        ObserverLocator.inject = <span class="fstat-no" title="function not covered" >function inject() {</span>
<span class="cstat-no" title="statement not covered" >          return [TaskQueue, EventManager, DirtyChecker, All.of(ObjectObservationAdapter)];</span>
        };
&nbsp;
...
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (hasObjectObserve) {
...
<span class="cstat-no" title="statement not covered" >            if (propertyName === 'length') {</span>
<span class="cstat-no" title="statement not covered" >              return this.getArrayObserver(obj).getLengthObserver();</span>
            } else {
<span class="cstat-no" title="statement not covered" >              return new DirtyCheckProperty(this.dirtyChecker, obj, propertyName);</span>
            }
          } else <span class="cstat-no" title="statement not covered" >if (obj instanceof Map) {</span>
<span class="cstat-no" title="statement not covered" >            if (propertyName === 'size') {</span>
<span class="cstat-no" title="statement not covered" >              return this.getMapObserver(obj).getLengthObserver();</span>
            } else {
<span class="cstat-no" title="statement not covered" >              return new DirtyCheckProperty(this.dirtyChecker, obj, propertyName);</span>
            }
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          return new SetterObserver(this.taskQueue, obj, propertyName);</span>
        };
&nbsp;
        ObserverLocator.prototype.getArrayObserver = function getArrayObserver(array) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if ('__array_observer__' in array) {
<span class="cstat-no" title="statement not covered" >            return array.__array_observer__;</span>
          }
&nbsp;
          return array.__array_observer__ = _getArrayObserver(this.taskQueue, array);
        };
&nbsp;
        ObserverLocator.prototype.getMapObserver = <span class="fstat-no" title="function not covered" >function getMapObserver(map) {</span>
<span class="cstat-no" title="statement not covered" >          if ('__map_observer__' in map) {</span>
<span class="cstat-no" title="statement not covered" >            return map.__map_observer__;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          return map.__map_observer__ = _getMapObserver(this.taskQueue, map);</span>
        };
&nbsp;
...
<span class="fstat-no" title="function not covered" >        function ObjectObservationAdapter() {</span>
<span class="cstat-no" title="statement not covered" >          _classCallCheck(this, ObjectObservationAdapter);</span>
        }
&nbsp;
        ObjectObservationAdapter.prototype.handlesProperty = <span class="fstat-no" title="function not covered" >function handlesProperty(object, propertyName, descriptor) {</span>
<span class="cstat-no" title="statement not covered" >          throw new Error('BindingAdapters must implement handlesProperty(object, propertyName).');</span>
        };
&nbsp;
        ObjectObservationAdapter.prototype.getObserver = <span class="fstat-no" title="function not covered" >function getObserver(object, propertyName, descriptor) {</span>
<span class="cstat-no" title="statement not covered" >          throw new Error('BindingAdapters must implement createObserver(object, propertyName).');</span>
        };
&nbsp;
