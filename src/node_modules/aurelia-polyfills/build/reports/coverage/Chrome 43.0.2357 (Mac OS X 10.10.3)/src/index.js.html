...
<div class="header medium">
    ...
    <h2>
        ...
        Branches: <span class="metric">56.25% <small>(36 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
  ...
  function trimDots(ary) {
    ...
    for (i = 0; i &lt; ary.length; ++i) {
      ...
      if (part === '.') {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (i === 0 || i == 1 &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >ary[2] === '..' </span>|| ary[i - 1] === '..') {
<span class="cstat-no" title="statement not covered" >          continue;</span>
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (i &gt; 0) {
          ary.splice(i - 1, 2);
          i -= 2;
        }
      }
...
&nbsp;
    for (i = 0, ii = url1.length; i &lt; ii; ++i) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (url1[i] == '..') {
<span class="cstat-no" title="statement not covered" >        url3.pop();</span>
...
<span class="cstat-no" title="statement not covered" >    return typeof obj === 'object' || typeof obj === 'function' ? class2type[toString.call(obj)] || 'object' : typeof obj;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function buildQueryString(a, traditional) {</span>
<span class="cstat-no" title="statement not covered" >    var prefix,</span>
        s = [],
        add = <span class="fstat-no" title="function not covered" >function add(key, value) {</span>
      // If value is a function, invoke it and return its value
<span class="cstat-no" title="statement not covered" >      value = typeof value === 'function' ? value() : value == null ? '' : value;</span>
...
<span class="cstat-no" title="statement not covered" >      _buildQueryString(prefix, a[prefix], traditional, add);</span>
    }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function _buildQueryString(prefix, obj, traditional, add) {</span>
...
<span class="cstat-no" title="statement not covered" >      obj.forEach(<span class="fstat-no" title="function not covered" >function (v, i) {</span></span>
...
<span class="cstat-no" title="statement not covered" >          _buildQueryString(prefix + '[' + (typeof v === 'object' ? i : '') + ']', v, traditional, add);</span>
        }
      });
    } else <span class="cstat-no" title="statement not covered" >if (!traditional &amp;&amp; type(obj) === 'object') {</span>
      // Serialize object item.
<span class="cstat-no" title="statement not covered" >      for (name in obj) {</span>
<span class="cstat-no" title="statement not covered" >        _buildQueryString(prefix + '[' + name + ']', obj[name], traditional, add);</span>
      }
    } else {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Jun 08 2015 12:51:37 GMT-0400 (EDT)</div>
</div>
