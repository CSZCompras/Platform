...
<html lang="en">
<head>
    <title>Code coverage report for src/decorators.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/decorators.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; decorators.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">System.register(['./decorator-applicator'], function (_export) {
  'use strict';
&nbsp;
...
&nbsp;
          ...
          simpleDecorator: <span class="fstat-no" title="function not covered" >function simpleDecorator(name, decorator) {</span>
<span class="cstat-no" title="statement not covered" >            Decorators[name] = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >              return new DecoratorApplicator().decorator(decorator);</span>
            };
&nbsp;
<span class="cstat-no" title="statement not covered" >            DecoratorApplicator.prototype[name] = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >              return this.decorator(decorator);</span>
            };
          }
        }
      };
